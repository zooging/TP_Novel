...
define gui.about = _p("""{size=-7}Тревожность — это индивидуальная психологическая особенность человека, проявляющаяся в его склонности часто волноваться по относительно малым поводам.
